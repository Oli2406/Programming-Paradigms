...
public class MinimalHouse extends House {
    ...
    private final int BUILD_COST = (int) r.nextGaussian(100000, 15000);
    private final int CARBON = (int) r.nextGaussian(40, 5);
    private final int AREA = (int) r.nextGaussian(100, 15);
    private final int LIFETIME = 50;
    private final int RENOVATION_INTERVAL = 20;
    private final int SERVICE_COST = (int) r.nextGaussian(3000, 500);
    private final int RENOVATION_COST = (int) r.nextGaussian(25000, 4000);
    private final int DEMOLISH_COST = (int) r.nextGaussian(20000, 3000);
    private final int WASTE_COST = (int) r.nextGaussian(10000, 2000);
    private final float SATISFACTION_RATE = 0.75f;
    private final float RENOVATION_CARBON = 0.75f * CARBON;
    private final int RENOVATION_WASTE = (int) r.nextGaussian(30, 4);
    private final int DEMOLITION_WASTE = (int) r.nextGaussian(50, 8);
